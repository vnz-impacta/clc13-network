...
## Associa a rt priv-rt-1b com a subnet privada priv-subnet-1b 
...
## Associa a rt pub-rt-1b com a subnet publica pub-subnet-1b 
...
resource "aws_flow_log" "flow_log" {
  log_destination      = "arn:aws:s3:::zorza-clc13-network-terraform-state"
